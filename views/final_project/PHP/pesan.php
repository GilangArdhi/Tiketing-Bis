        ...
        <div class="row bg-light">
                ...
                <div class="container mt-5 mx-1 py-2 border">
                    ...
                    <div class="row">
                        <div class="col-2 px-4">
                            <img src="<?php echo base_url()?>assets/Pemesanan_Tiket_Bus/steeringwheel.jpeg" class="img-fluid  mt-2 mx-4"
                                alt="steeringwheel">
                        </div>
                        <div class="col-9">
            ...
            <div class="col-4" id="col2">
                ...
                <div class="row">
                    ...
                    <div class="col text-end" name="totHarga" id="harga"><b><?php echo $jadwal->harga * $objFilter['jmlPenumpang'] ?></b></div>
                </div>
                <div class="row">
        ...
        <div class="offcanvas offcanvas-end" id="rincian">
            ...
            <?php echo form_open('Home/rincianPembelian')?>
                ...
                <div class="row border-top mt-3">
                    ...
                    <div class="col-sm-3 text-end mt-2" id="totHarga" name="totHarga"><b><?php echo $jadwal->harga * $objFilter['jmlPenumpang'] ?></div>
                </div>
