                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <?php foreach ($travelin as $trv): ?>
                                            <?php echo form_open('User/delUser') ?>
                                            <tr>
                                                <td>
                                                    <?php echo $trv['id_user']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $trv['email']; ?>
                                                </td>
                                                ...
                                                <td width="150">
                                                    <div class="btn-group d-flex justify-content-around gap-4">
                                                        <button type="submit" value="<?php echo $trv['id_user'] ?>"
                                                            class="btn btn-danger btn-sm" name='idUser' onclick="return confirm('Apakah anda yakin menghapus data?')">Delete</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php echo form_close(); ?>
